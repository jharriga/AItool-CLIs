...
echo "Running automated tasks with Gemini..."
...
echo "Analyzing PCP Archive with Gemini to create a Graph..."
...
echo "Analyzing PCP Archive with Gemini to create a Grafana Dashboard..."
# --- NOTE: PCParchive.json was previously created using pcp2json
